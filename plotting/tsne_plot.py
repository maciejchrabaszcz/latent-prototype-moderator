...
from utils import color_palette, models_names, set_plot_style
...
if __name__ == "__main__":
    ...
    plot = sns.lineplot(
        plot_df[plot_df.layer != 0], x="layer", y="f1", hue="model", palette=color_palette
    )
    plt.xlabel("Layer")
    ...
    plt.ylabel("F1 Score on WildGuardTest")
    plt.tight_layout()
