    ...
    def __init__(
        ...
        for example in examples:
            if self.use_chat_template:
                ...
                positive = tokenizer.apply_chat_template(message_a, tokenize=False, add_generation_prompt=True)
                negative = tokenizer.apply_chat_template(message_b, tokenize=False, add_generation_prompt=True)
            else:
